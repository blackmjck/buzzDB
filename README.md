...
2. _(optional)_ Create database `buzz` and collection `words` inside it.
3. _(optional)_ Populate with test data from the samples provided in `buzzwords.js`
...
Parameter | Description       | Required? | Type    | Values | Default
--------- | ----------------- | --------- | ------- | ------ | -------
noun      | Noun form         | No_*_      | String  |        |
verb      | Verb form (infinitive) | No_*_ | String  |        |
adj       | Adjectival form   | No_*_      | String  |        |

_*_ Requests must include at least one of: `noun`, `verb`, or `adj`
